...
const byte socBajo = 75;           //70 Valor a mantener minimo de SOC. A partir de éste valor Relé ativado
const byte limiteBajoSOC = 20;     //20 Limite para el SOC más bajo
const byte histeresisAlto = 30;    //25 Histéresis SOC más bajo
...
const byte marcaBaja = 75;         // 70 Este valor tambien condiciona a partir de carga voltajeMaximo
...
const byte mostrarNivelCarga = 5;  // Rango para mostrar el nivel de carga de la batería +-
