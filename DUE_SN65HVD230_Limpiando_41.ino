...
const unsigned int tiempoInactivoA0 = 15000;  // 15 segundos en milisegundos
...
// Dentro de tu bucle principal o función donde actualizas la pantalla

if (PAValor > -1 && PAValor < 1) {
