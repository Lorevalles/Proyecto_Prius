...
void setup() {
  ...
  sendCommand(0xE1);  // Valor ajustado para reducir la frecuencia (consultar la hoja de datos del SSD1322 para los valores apropiados)
  ...
  // Ajustar la configuración de voltaje de suministro
  sendCommand(0xAB);  // Establecer la fuente de alimentación interna de voltaje
  sendCommand(0x01);  // Valor ajustado para la fuente de alimentación interna
  ...
  // Can0.watchFor(0x18DB33F1);  // ID 0x18DB33F1, DLC 8, Pregunta conexión 7DF equivalente
  // Can0.watchFor(0x039);  // ID 0x039 , DLC 4, ICE Temperature (A) 4 30 02 0D 7C (de 0 a 255 °C)
